...
export default function RadarPage() {
  const systems = [
    {
      name: "AN/MPQ-65 Radar",
      role: "Phased-array radar for tracking and missile guidance",
      img: "/images/patriot-radar.jpg",
      link: "/products/patriot-radar",
    },
  ];
  ...
  return (
    <main className="text-white">
      ...
      <section className="h-[60vh] relative flex items-end px-10 pb-16">
        <img src="/images/patriot-radar.jpg" className="absolute inset-0 w-full h-full object-cover" />
        ...
        <div className="relative z-10 max-w-xl">
          ...
          <p className="text-gray-300">
            Advanced detection, tracking, and battlefield awareness systems.
          </p>
        </div>
      </section>
