...
export default function ForceMultipliersPage() {
  const products = [
    {
    ...
    },
    {
      ...
      role: "Aerial refueling platform",
      img: "/images/kc135.jpg",
      link: "/products/kc135",
    },
    {
      name: "KC-46 Pegasus",
      role: "Next-gen tanker and logistics support",
      img: "/images/kc46.jpg",
      link: "/products/kc46",
    },
  ];
  ...
  return (
    <main className="text-white">
      ...
      <section className="h-[60vh] relative flex items-end px-10 pb-16">
        <img src="/images/awacs-hero.jpg" className="absolute inset-0 w-full h-full object-cover" />
        ...
        <div className="relative z-10">
          ...
          <p className="text-gray-300 max-w-lg">
            Strategic support platforms that extend operational reach,
            enhance coordination, and provide real-time intelligence.
          </p>
        </div>
      </section>
